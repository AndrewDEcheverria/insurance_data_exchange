...
(Note: When importing data with these tables, primary keys will not add duplicate rows. We will be using staging tables with no primary keys to make sure data cleaning protocols are working)
